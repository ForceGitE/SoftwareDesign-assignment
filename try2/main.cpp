...
int main()
{
    ...
    cout<<"log in names: peter warren eoin ciaran admin\npasswords pp ww ee cc admin\n\n"
        <<"the createXML function in main is commented out as we do not want to create a file every time we run main\n"
        <<"we only want to read the file everytime\n"
        <<"uncomment createXML in main if you want to create an XML file\n"<<endl;
